...
ZA_CORPUS = {
    ...
    'ZA 5': {
        ...
        'condition': 'complete',
        'notes': 'Grain. ku-do-ni (Kydonia), a-du, mi-nu-te. Total 20+10+5=35.',
    },
    'ZA 6': {
        'site': 'Zakros', 'type': 'tablet', 'period': 'LM IB',
